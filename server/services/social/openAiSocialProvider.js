...
const SOCIAL_PROMPTS = Object.freeze({
  ...
  weekly_candidates: {
    version: "social-weekly-candidates-v1",
    instructions: [
  ...
  weekly_plan: {
    ...
    instructions: [
      ...
      "Select no more than the supplied weekly maximum, normally three. Use only supplied candidate IDs and configured Asia/Kolkata slots.",
