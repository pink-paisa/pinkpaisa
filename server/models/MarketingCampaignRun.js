...
const MarketingCampaignRunSchema = new mongoose.Schema({
  ...
  carousel_task_id: { type: mongoose.Schema.Types.ObjectId, ref: "AgentTask", default: null, index: true },
  carousel_position: { type: Number, default: null, min: 1, max: 10 },
  carousel_size: { type: Number, default: null, min: 2, max: 10 },
